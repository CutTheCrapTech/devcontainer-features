...
class TestHandleBranchChange:
  ...
  @patch("auto_secrets.cli.ConfigManager.load_config")
  @patch("auto_secrets.cli.BranchManager")
  def test_handle_branch_change_no_mapping(self, mock_branch_manager: MagicMock, mock_load_config: MagicMock) -> None:
...
class TestHandleInspectSecrets:
  ...
  @patch("auto_secrets.cli.ConfigManager.load_config")
  @patch("auto_secrets.cli.CacheManager")
  def test_handle_inspect_secrets_with_cache(self, mock_cache_manager: MagicMock, mock_load_config: MagicMock) -> None:
  ...
  @patch("auto_secrets.cli.ConfigManager.load_config")
  @patch("auto_secrets.cli.CacheManager")
  def test_handle_inspect_secrets_no_cache(self, mock_cache_manager: MagicMock, mock_load_config: MagicMock) -> None:
...
class TestHandleExecCommand:
  ...
  @patch("auto_secrets.cli.ConfigManager.load_config")
  @patch("auto_secrets.cli.CacheManager")
  def test_handle_exec_command_no_secrets(self, mock_cache_manager: MagicMock, mock_load_config: MagicMock) -> None:
...
class TestHandleCleanup:
  ...
  @patch("auto_secrets.cli.ConfigManager.load_config")
  @patch("auto_secrets.cli.CacheManager")
  def test_handle_cleanup_all(self, mock_cache_manager: MagicMock, mock_load_config: MagicMock) -> None:
  ...
  @patch("auto_secrets.cli.ConfigManager.load_config")
  @patch("auto_secrets.cli.CacheManager")
  def test_handle_cleanup_stale(self, mock_cache_manager: MagicMock, mock_load_config: MagicMock) -> None:
...
class TestBackgroundRefreshSecrets:
  ...
  @patch("auto_secrets.cli.create_secret_manager")
  @patch("auto_secrets.cli.CacheManager")
  def test_background_refresh_success(self, mock_cache_manager: MagicMock, mock_create_manager: MagicMock) -> None:
...
class TestMainFunction:
  ...
  def test_main_branch_change_command(
    ...
    with (
      patch("auto_secrets.cli.handle_branch_change") as mock_handle,
      patch.dict(
        os.environ,
        {
  ...
  def test_main_refresh_command(
    ...
    with (
      patch("auto_secrets.cli.handle_refresh_secrets") as mock_handle,
      patch.dict(
        os.environ,
        {
          "AUTO_SECRETS_SECRET_MANAGER": "infisical",
  ...
  def test_main_inspect_command(
    ...
    with (
      patch("auto_secrets.cli.handle_inspect_secrets") as mock_handle,
      patch.dict(
        os.environ,
        {
          "AUTO_SECRETS_SECRET_MANAGER": "infisical",
  ...
  def test_main_exec_command(
    ...
    with (
      patch("auto_secrets.cli.handle_exec_command") as mock_handle,
      patch.dict(
        os.environ,
        {
          "AUTO_SECRETS_SECRET_MANAGER": "infisical",
  ...
  def test_main_debug_command(
    ...
    with (
      patch("auto_secrets.cli.handle_debug_env") as mock_handle,
      patch.dict(
        os.environ,
        {
          "AUTO_SECRETS_SECRET_MANAGER": "infisical",
  ...
  def test_main_cleanup_command(
    ...
    with (
      patch("auto_secrets.cli.handle_cleanup") as mock_handle,
      patch.dict(
        os.environ,
        {
          "AUTO_SECRETS_SECRET_MANAGER": "infisical",
  ...
  @patch("auto_secrets.cli.ConfigManager.load_config")
  @patch("auto_secrets.cli.setup_logging")
  def test_main_unknown_command(self, mock_setup_logging: MagicMock, mock_load_config: MagicMock) -> None:
    ...
    with (
      ...
      patch("auto_secrets.cli.argparse.ArgumentParser") as MockParser,
    ):
  ...
  def test_main_quiet_logging(
    ...
    with (
      patch("auto_secrets.cli.handle_debug_env"),
      patch.dict(
        os.environ,
        {
          "AUTO_SECRETS_SECRET_MANAGER": "infisical",
...
class TestCLIIntegration:
  ...
  def test_error_handling_workflow(self) -> None:
    ...
    with (
      patch("auto_secrets.cli.ConfigManager.load_config", return_value={}),
      patch(
