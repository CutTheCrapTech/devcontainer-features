...
from auto_secrets.core.cache_manager import CacheError, CacheManager, CacheMetadata
...
class TestCacheMetadata:
  ...
  @patch("time.time")
  def test_age_seconds(self, mock_time: MagicMock) -> None:
...
class TestCacheManager:
  ...
  def setup_method(self) -> None:
    ...
    self.test_config: dict[str, Any] = {"cache_config": {"max_age_seconds": 900, "cache_dir": "/tmp/test_cache"}}
  ...
  def _get_temp_config(self) -> dict[str, Any]:
  ...
  def test_init_with_config(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_init_default_max_age(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
    """Test CacheManager with default max_age_seconds."""
    mock_get_cache_dir.return_value = Path("/tmp/test_cache")
    mock_get_base_dir.return_value = Path("/tmp/test_base")
    config: dict[str, Any] = {"cache_config": {}}
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_init_no_cache_config(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_ensure_cache_directory_success(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  def test_ensure_cache_directory_failure(
    self,
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_get_environment_cache_dir(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  @patch("time.time")
  def test_update_environment_cache_success(
    self,
    mock_time: MagicMock,
    mock_get_base_dir: MagicMock,
    mock_get_cache_dir: MagicMock,
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      with (
        ...
        metadata_call = mock_write_file.call_args_list[1]
        assert "production.json" in str(metadata_call[0])

  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_update_environment_cache_with_branch_info(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      with (
        ...
        # Get the 2nd call (index 1) - this should be the production.json write
        second_call = mock_write_file.call_args_list[1]

        # Verify metadata includes branch info
        metadata_content = second_call[0][1]["metadata"]
        assert metadata_content["branch"] == "main"
        assert metadata_content["repo_path"] == "/repo"

  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_get_cached_secrets_success(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_get_cached_secrets_not_found(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_get_cached_secrets_corrupted(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_get_cached_secrets_with_paths_filter(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      with (
        patch.object(manager, "_update_access_time"),
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_is_cache_stale_true(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_is_cache_stale_false(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_is_cache_stale_missing_metadata(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_mark_environment_stale(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_cleanup_stale(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_cleanup_all(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_get_cache_info(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  def test_update_access_time_success(self) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      metadata = CacheMetadata.from_dict(cache_data["metadata"])

      with patch("time.time", return_value=1234567950):
        manager._update_access_time(str(cache_file), metadata)

        # Check that access time was updated
        with open(cache_file) as f:
          updated_data = json.load(f)

        assert updated_data["metadata"]["last_accessed"] == 1234567890
  ...
  def test_update_access_time_failure(self) -> None:
    ...
    invalid_file = "/invalid/path/metadata.json"
    metadata = CacheMetadata(
      environment="test",
      created_at=0,
      last_updated=0,
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_get_cache_stats(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_get_cache_stats_empty(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_integration_full_cache_lifecycle(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_error_handling_permissions(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      try:
        with (
          patch.object(manager, "get_environment_cache_dir", return_value=readonly_dir),
          pytest.raises(CacheError),
        ):
          manager.update_environment_cache("test", {"key": "value"}, "main", "/repo")
      finally:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_concurrent_access_simulation(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      with patch("time.time", return_value=1234567890):
        manager.update_environment_cache("test1", secrets1, "main", "/repo")
        manager.update_environment_cache("test2", secrets2, "main", "/repo")
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_large_secrets_handling(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      with patch("time.time", return_value=1234567890):
        manager.update_environment_cache("large_env", large_secrets, "main", "/repo")
...
class TestMergeStateFileAtomically:
  """Test _merge_state_file_atomically method."""

  def setup_method(self) -> None:
    """Set up test fixtures."""
    self.test_config: dict[str, Any] = {"cache_config": {"max_age_seconds": 900}}
    self.temp_dir: Any = None
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_new_file(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      state_file = base_dir / "state" / "current_branch.json"
      assert state_file.exists()

      with open(state_file) as f:
        data = json.load(f)

      expected_key = "main:/repo/path"
      assert expected_key in data
      assert data[expected_key] == "production"

  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_existing_file(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      existing_data = {"develop:/other/repo": "staging"}
      ...
      assert "develop:/other/repo" in data
      assert data["develop:/other/repo"] == "staging"
      assert "main:/repo/path" in data
      assert data["main:/repo/path"] == "production"

  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_overwrite_existing_key(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      # Create existing state file with same branch:repo_path
      state_dir = base_dir / "state"
      state_dir.mkdir(parents=True)
      state_file = state_dir / "current_branch.json"

      existing_data = {"main:/repo/path": "staging"}
      with open(state_file, "w") as f:
        json.dump(existing_data, f)
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_corrupted_existing_file(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      # Should create new state ignoring corrupted data
      assert "main:/repo/path" in data
      assert data["main:/repo/path"] == "production"

  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_empty_branch_error(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_empty_repo_path_error(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_empty_environment_error(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      with pytest.raises(CacheError, match="Environment name cannot be empty"):
        manager._merge_state_file_atomically("main", "/repo/path", "")

  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_none_branch_error(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_none_repo_path_error(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_special_characters(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      branch = "feature/special-chars@123"
      repo_path = "/path/with spaces/and-dashes"
      environment = "prod-env_123"

      manager._merge_state_file_atomically(branch, repo_path, environment)

      state_file = base_dir / "state" / "current_branch.json"
      with open(state_file) as f:
        data = json.load(f)

      expected_key = f"{branch}:{repo_path}"
      assert expected_key in data
      assert data[expected_key] == environment

  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_multiple_entries(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      manager._merge_state_file_atomically("main", "/repo1", "production")
      manager._merge_state_file_atomically("develop", "/repo1", "staging")
      manager._merge_state_file_atomically("feature", "/repo2", "development")
      ...
      assert len(data) == 3
      assert data["main:/repo1"] == "production"
      assert data["develop:/repo1"] == "staging"
      assert data["feature:/repo2"] == "development"

  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_permission_error(self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_atomic_write_failure(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_creates_directory_structure(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
  ...
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_concurrent_access_simulation(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      # Simulate concurrent writes by multiple calls
      manager._merge_state_file_atomically("branch1", "/repo1", "env1")
      manager._merge_state_file_atomically("branch2", "/repo2", "env2")
      manager._merge_state_file_atomically("branch3", "/repo1", "env3")
      ...
      assert len(data) == 3
      assert data["branch1:/repo1"] == "env1"
      assert data["branch2:/repo2"] == "env2"
      assert data["branch3:/repo1"] == "env3"

  @patch("auto_secrets.core.cache_manager.ConfigManager.get_cache_dir")
  @patch("auto_secrets.core.cache_manager.ConfigManager.get_base_dir")
  def test_merge_state_file_preserves_file_permissions(
    self, mock_get_base_dir: MagicMock, mock_get_cache_dir: MagicMock
  ) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
      ...
      # Check that file has restrictive permissions (600 = rw-------)
