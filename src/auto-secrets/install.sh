...
SECRET_MANAGER_CONFIG_JSON=${SECRETMANAGERCONFIG:-'{"projectId":"","domain":"https://app.infisical.com","authMethod":"universal-auth","clientId":""}'}
...
export DEV_ENV_MANAGER_AUTO_COMMANDS_JSON='$AUTO_COMMANDS_JSON'

$(generate_full_config \
    'Cache configuration:CACHE:'"$CACHE_CONFIG_JSON" \
